...
export default function Development() {
  return (
    <>
      <Helmet>
        <title>Development | Abidh Creative</title>
        <meta name="description" content="Custom web and app development services. Build your digital future with Abidh Creative." />
      </Helmet>
      <motion.section
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-700 max-w-2xl text-center mb-8">
          Custom web and app development services. Build your digital future with Abidh Creative’s expert team.
        </p>
